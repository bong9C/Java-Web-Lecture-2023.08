   				...
   				<form action="/sample/user/register" method="post">
   					<table class="table table-borderless">
   						...
   						<tr>
   							...
   							<td><input type="text" name="pwd2" class="form-comtrol"></td>							
   						</tr>
   						<tr>
   							<td><label class="col-form-label">이름</label></td>
   							<td><input type="text" name="uname" class="form-comtrol"></td>							
   						</tr>
   						<tr>
   							<td><label class="col-form-label">이메일</label></td>
   							<td><input type="text" name="email" class="form-comtrol"></td>							
   						</tr>
   						<tr>
	   						<td colspan="2">
